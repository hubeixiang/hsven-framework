package org.framework.hsven.mybatis.parser.handler.xmltagls;

import org.apache.ibatis.parsing.GenericTokenParser;
import org.apache.ibatis.parsing.TokenHandler;
import org.apache.ibatis.scripting.xmltags.DynamicContext;
import org.apache.ibatis.scripting.xmltags.SqlNode;
import org.framework.hsven.mybatis.parser.handler.xmltagls.custom.CommonBindingTokenParser;
import org.framework.hsven.mybatis.parser.handler.xmltagls.custom.NumberBindingTokenParser;
import org.framework.hsven.mybatis.parser.handler.xmltagls.custom.NumberMultipleBindingTokenParser;
import org.framework.hsven.mybatis.parser.handler.xmltagls.custom.StringMultipleBindingTokenParser;
import org.framework.hsven.mybatis.parser.handler.xmltagls.custom.MybatisBindingTokenParser;
import org.framework.hsven.mybatis.parser.handler.xmltagls.custom.StringBindingTokenParser;
...
public class MixTextSqlNode implements SqlNode {
	...
	public boolean apply(DynamicContext context) {
		...
		if (isNumberManyParser) {
			GenericTokenParser numberManyParser = NumberMultipleBindingTokenParser
					.createParser(new NumberMultipleBindingTokenParser(context));
