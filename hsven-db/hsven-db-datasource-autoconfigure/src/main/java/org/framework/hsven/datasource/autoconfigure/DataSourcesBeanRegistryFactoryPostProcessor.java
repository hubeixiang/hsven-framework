...
public class DataSourcesBeanRegistryFactoryPostProcessor implements BeanDefinitionRegistryPostProcessor {
	...
	private void createAtomikosDataSourceBeans(boolean primary, String dbName, DataSourceConfig dataSourceConfig,
		...
		registry.registerBeanDefinition(DataSourceNameGenerator.getDataSourceBeanName(dbName), definition);
	}
	...
	private void createSpringJdbcTemplate(String dbName) {
		...
		builder.addConstructorArgReference(DataSourceNameGenerator.getDataSourceBeanName(dbName));

		registry.registerBeanDefinition(DataSourceNameGenerator.getSpringJdbcTemplate(dbName), builder.getBeanDefinition());
	}
}
