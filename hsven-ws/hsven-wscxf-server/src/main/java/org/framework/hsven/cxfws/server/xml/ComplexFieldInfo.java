...
public class ComplexFieldInfo implements AbstractFieldInfo{
    private String fieldChName;
    private String fieldEnName;
    private String fieldContent;

    public static ComplexFieldInfo of(String fieldChName, String fieldEnName, String fieldContent) {
        ComplexFieldInfo fieldInfo = new ComplexFieldInfo();
