package org.framework.hsven.utils.id;

import org.framework.hsven.utils.constant.CommonConstants;

import java.io.UnsupportedEncodingException;

/**
 * 冗余检查算法,id生成器
 * crc & md5low64 algorithm
 */
public class RedundancyCheckIDGenerator {
	...
	public static int getCRC32(String val)
	{
		...
		try
		{
			bytes = val.getBytes(CommonConstants.encode_GBK);
		}
	...
	public static long getMD5Low64(String val,String encodeStr)
	{
		...
		try
		{
			java.security.MessageDigest messageDigest = java.security.MessageDigest.getInstance(CommonConstants.algorithm_MD5);
	...
	{
		return	getMD5Low64(val,CommonConstants.encode_GBK);
	}
}
