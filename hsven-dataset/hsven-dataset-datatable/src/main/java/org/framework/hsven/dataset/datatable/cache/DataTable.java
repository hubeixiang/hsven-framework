...
public class DataTable {
    ...
    public Object getFieldOriginValue(int rowIndex, String fieldName) {
        ...
        try {
            ...
            switch (colsInfo[jj].type) {
                case DtInt: {
                    int value = ((int[]) (cols[jj]))[rowIndex];
                ...
                case DtDouble: {
                    double value = ((double[]) (cols[jj]))[rowIndex];
                    if (value == DataSetUtil.DOUBLE_MIN_VALUE) {
                        returnValue = null;
                    } else {
                        returnValue = value;
                    }
                ...
                case DtLong: {
                    long value = ((long[]) (cols[jj]))[rowIndex];
                ...
                case DtFloat: {
                    float value = ((float[]) (cols[jj]))[rowIndex];
                    if (value == DataSetUtil.FLOAT_MIN_VALUE) {
                        returnValue = null;
                    } else {
                        returnValue = value;
                    }
                ...
                case DtShort: {
                    short value = ((short[]) (cols[jj]))[rowIndex];
            ...
            logger.error("getFieldOriginValue Exception.fieldName:" + fieldName + ",rowIndex:" + rowIndex, ee);
        }
        return null;
    }
